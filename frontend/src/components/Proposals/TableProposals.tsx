...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/proposals/proposalsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureProposalsCols';
...
const TableSampleProposals = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (proposalsNotify.showNotification) {
      notify(
        proposalsNotify.typeNotification,
        proposalsNotify.textNotification,
      );
    }
  }, [proposalsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/proposals/proposals-view/?id=${id}`);
  };
...
export default TableSampleProposals;
