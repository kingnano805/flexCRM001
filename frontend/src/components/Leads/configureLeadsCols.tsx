  ...
  return [
...

    {
      ...
      valueGetter: (params: GridValueGetterParams) =>
        new Date(params.row.last_contacted),
    },

    {
      ...
      valueFormatter: ({ value }) =>
        dataFormatter.interactionsManyListFormatter(value).join(', '),
      renderEditCell: (params) => (
        <DataGridMultiSelect {...params} entityName={'interactions'} />
      ),
    },
