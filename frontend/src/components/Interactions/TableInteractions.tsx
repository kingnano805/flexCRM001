...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/interactions/interactionsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureInteractionsCols';
...
const TableSampleInteractions = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (interactionsNotify.showNotification) {
      notify(
        interactionsNotify.typeNotification,
        interactionsNotify.textNotification,
      );
    }
  }, [interactionsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/interactions/interactions-view/?id=${id}`);
  };
...
export default TableSampleInteractions;
