...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_INTERACTIONS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_INTERACTIONS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_INTERACTIONS'),
      },
      {
        createdAt,
        updatedAt,
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_PROPOSALS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_PROPOSALS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_PROPOSALS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_PROPOSALS'),
      },
